...
public class PopularityLeague extends Configured implements Tool {
    ...
    public static class PopularityLeagueReduce extends Reducer<NullWritable, IntArrayWritable, IntWritable, IntWritable> {
        ...
        private TreeSet<Pair<Integer, Integer>> popularityLeagueMap = new TreeSet<Pair<Integer, Integer>>();
        ...
        public void reduce(NullWritable key, Iterable<IntArrayWritable> values, Context context) throws IOException, InterruptedException {
            ...
            for (IntArrayWritable val : values) {
                ...
                countToLeagueMap.add(new Pair<Integer, Integer>(count, link));
                                
            }
            System.out.println(countToLeagueMap);
            Integer rank = -1;
            
            Integer lastCount = -1;
            Integer rankJump = 1;
            for (Pair<Integer, Integer> entry : countToLeagueMap) {
                Integer count = entry.first;     
                Integer link = entry.second;
                ...
                System.out.println("Link: "+link+" Count: "+count);
                popularityLeagueMap.add(new Pair<Integer, Integer>(link, rank));
                
                lastCount = count;
                 
            }

            while (!popularityLeagueMap.isEmpty()) {
                Pair<Integer, Integer> item = popularityLeagueMap.pollLast();
				IntWritable link = new IntWritable(item.first);
